                ...
                <div class="content-center text-left col-md-7 col-lg-4">
                    <div class="card card-contact card-raised p-3 bg-white">
                        <div class="card-header text-center">
                            ...
                            <h3 class="card-title text-dark display-3 mt-2"> <strong>Cambiar contraseña</strong>...</h3>
                        ...
                        <div class="card-body pb-0">
                            ...
                            @endif
                            <!-- Formulario -->
                            <form role="form" method="post" action="{{route('restore.save')}}" autocomplete="off">
                                {{ csrf_field() }}
                                ...
                                <div class="form-group has-feedback">
                                    <div class="input-group">
                                        ...
                                        <input type="password" name="password_confirmation" class="form-control" placeholder="Confirmar contraseña" required autofocus>
                                    </div>
                                </div>
                                <div class="card-footer text-center">
                                    <div class="col-xs-12" style="padding-bottom: 15px;">
                                        <button type="submit" class="btn btn-info btn-round btn-lg btn-block">Actualizar</button>
                                    </div>
                                </div>
                            </form>
                        </div>
